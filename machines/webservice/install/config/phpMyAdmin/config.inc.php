...
$cfg['Servers'][$i]['socket'] = '/var/run/socket/mysqld/mysql.sock';
...
$cfg['UploadDir'] = '/drives/AppData/Backups/phpMyAdmin';
$cfg['SaveDir'] = '/drives/AppData/Backups/phpMyAdmin';
